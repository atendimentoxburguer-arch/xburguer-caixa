...
set expected_cash = opening_balance + cash_sales + delivery_cash_sales - cash_withdrawn_for_expenses,
    cash_difference = case
      when cash_count_verified then counted_cash - (opening_balance + cash_sales + delivery_cash_sales - cash_withdrawn_for_expenses)
      else 0
    end;
